...
async function captureVisualTest(
  ...
  const rendererDiagnostic = await window.webContents.executeJavaScript(`({
    ...
    voiceActive: document.querySelector('.ambient-companion')?.dataset.voiceActive ?? null,
    voiceSessionDockVisible: Boolean(document.querySelector('.voice-session-dock')),
