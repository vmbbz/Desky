...
const freeAdmittedRevisions: readonly AdmittedAvatarRevision[] = [{
  avatar: {
    ...
    name: 'Milk',
    description: 'The light, expressive carton companion used to prove Deskii’s VRM and motion foundations.',
  ...
  avatar: {
    ...
    name: 'Astronaut',
    description: 'A compact suited explorer that broadens Deskii’s free animation and framing test portfolio.',
    creator: 'Polygonal Mind',
    projectId: '100avatars-r1',
    projectName: '100Avatars R1',
    sourceUrl: 'https://github.com/ToxSam/open-source-avatars',
...
const paidPilotRevisions: readonly AdmittedAvatarRevision[] = [{
  avatar: {
    ...
    name: 'Toothpaste',
    description: 'A bright, expressive tube companion selected for Deskii’s first capped paid-pilot checkout.',
    creator: 'Polygonal Mind',
    projectId: '100avatars-r1',
    projectName: '100Avatars R1',
    sourceUrl: 'https://github.com/ToxSam/open-source-avatars',
