...
const freeAdmittedRevisions: readonly AdmittedAvatarRevision[] = [{
  avatar: {
    ...
    name: 'Milk',
    description: 'The light, expressive carton companion used to prove Deskiii’s VRM and motion foundations.',
  ...
  avatar: {
    ...
    name: 'Astronaut',
    description: 'A compact suited explorer that broadens Deskiii’s free animation and framing test portfolio.',
    creator: 'Polygonal Mind',
    projectId: '100avatars-r1',
    projectName: '100Avatars R1',
    sourceUrl: 'https://github.com/ToxSam/open-source-avatars',
...
const paidPilotRevisions: readonly AdmittedAvatarRevision[] = [{
  avatar: {
    ...
    name: 'Toothpaste',
    description: 'A bright, expressive tube companion selected for Deskiii’s first capped paid-pilot checkout.',
    creator: 'Polygonal Mind',
    projectId: '100avatars-r1',
    projectName: '100Avatars R1',
    sourceUrl: 'https://github.com/ToxSam/open-source-avatars',
