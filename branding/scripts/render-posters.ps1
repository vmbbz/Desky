...
$throughScreenFilter = "drawtext=fontfile='$ffmpegFontPath':text='DESKIII':fontcolor=0x0A0E17:fontsize=84:x=(w-text_w)/2:y=222,drawbox=x=(iw-64)/2:y=325:w=64:h=5:color=0x75E6D7:t=fill,drawtext=fontfile='$ffmpegFontPath':text='Give your agent somewhere to be.':fontcolor=0x111827:fontsize=31:x=(w-text_w)/2:y=358"
$schoolDeskFilter = "drawtext=fontfile='$ffmpegFontPath':text='DESKIII':fontcolor=0x0A0E17:fontsize=104:x=142:y=310,drawbox=x=148:y=428:w=64:h=5:color=0x75E6D7:t=fill,drawtext=fontfile='$ffmpegFontPath':text='Give your agent somewhere to be.':fontcolor=0x111827:fontsize=34:x=148:y=465"
$firstSignalFilter = "drawtext=fontfile='$ffmpegFontPath':text='FIRST SIGNAL':fontcolor=0x75E6D7:fontsize=25:x=140:y=148,drawbox=x=140:y=194:w=54:h=5:color=0x75E6D7:t=fill,drawtext=fontfile='$ffmpegFontPath':text='DESKIII':fontcolor=0xF5F8FF:fontsize=112:x=132:y=218,drawtext=fontfile='$ffmpegFontPath':text='Give your agent somewhere to be.':fontcolor=0xF5F8FF:fontsize=39:x=140:y=368"
